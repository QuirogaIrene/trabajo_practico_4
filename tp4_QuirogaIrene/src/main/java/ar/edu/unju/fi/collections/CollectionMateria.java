...
public class CollectionMateria {
	...
	public static void modificarMateria(Materia materia) {
		for (Materia mate: materias) {
			if (mate.getCodigo() == materia.getCodigo()) {
				...
				System.out.println("No se encuentra el codigo de Materia");
			}
		}
	...
	/*Busca un objeto materia dentro del arrayList, el criterio es por @param  codigo, el codigo a buscar en el arrayList materias @return*/
